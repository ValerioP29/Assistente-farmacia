                ...
                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            Gestisci pazienti, percorsi terapeutici, consensi, controlli periodici e promemoria.
                        </p>
                    </div>
                        ...
                        <div class="module-card h-100">
                            <div class="module-card-header d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Seleziona un paziente per gestire le terapie collegate</p>
                                </div>
                                <button class="btn btn-sm btn-outline-primary" id="refreshDataButton">
                    ...
                    <div class="col-lg-8">
                        <div class="module-card h-100">
                            <div class="module-card-header">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <p class="text-muted small mb-0">Storico completo delle terapie del paziente selezionato</p>
                                    </div>
                            ...
                            <div class="module-card-body" id="therapiesContainer">
                                <div class="empty-state">
                                    <i class="fas fa-prescription-bottle-alt"></i>
                                    <p>Seleziona un paziente per visualizzare le terapie associate.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="module-card">
                    <div class="module-card-header d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted small mb-0">Visualizza le attività programmate e lo storico</p>
                        </div>
                    ...
                    <div class="module-card-body">
                        <div id="timelineContainer" class="timeline">
                            <div class="empty-state">
                                ...
                                <p>Nessuna attività pianificata. Aggiungi un promemoria o un check periodico.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" name="notes" rows="3" placeholder="Allergie, patologie, informazioni utili..."></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-header">
                    <div>
                        <h5 class="modal-title" id="therapyModalLabel">
                            <i class="fas fa-prescription-bottle-alt me-2"></i><span>Nuova Terapia</span>
                        </h5>
                        <small class="text-muted">Compila il percorso guidato per registrare la terapia e il questionario iniziale</small>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Chiudi"></button>
                </div>
                <div class="modal-body">
                    ...
                    <input type="hidden" name="questionnaire_payload" id="questionnairePayloadInput">
                    <input type="hidden" name="caregivers_payload" id="caregiversPayloadInput">

                    <div class="wizard-progress">
                        <div class="wizard-progress-bar">
                            <div class="wizard-progress-indicator" id="therapyWizardIndicator"></div>
                        </div>
                    ...
                    <div class="wizard-content">
                        ...
                        <section class="wizard-step active" data-step="1">
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-select" id="therapyPatientSelect" name="existing_patient">
                                        <option value="">-- Seleziona paziente --</option>
                                    </select>
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label">Oppure crea un nuovo paziente</label>
                                    <div class="d-grid">
                                        <button type="button" class="btn btn-outline-primary" id="openInlinePatientForm">
                                            <i class="fas fa-user-plus me-2"></i>Compila dati paziente
                                        </button>
                                    </div>
                                </div>
                                <div class="col-12 collapse" id="inlinePatientForm">
                                    <div class="border rounded p-3 bg-light">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <label class="form-label">Nome</label>
                                                <input type="text" class="form-control" name="inline_first_name">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Cognome</label>
                                                <input type="text" class="form-control" name="inline_last_name">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label">Data di nascita</label>
                                                <input type="date" class="form-control" name="inline_birth_date">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label">Telefono</label>
                                                <input type="tel" class="form-control" name="inline_phone">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label">Email</label>
                                                <input type="email" class="form-control" name="inline_email">
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label">Note</label>
                                                <textarea class="form-control" name="inline_notes" rows="2"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <section class="wizard-step" data-step="2">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div id="caregiversContainer" class="caregivers-container">
                                        <div class="caregiver-row template d-none">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="col-md-2">
                                                    <button type="button" class="btn btn-outline-danger w-100 remove-caregiver">
                                    ...
                                    <button type="button" class="btn btn-outline-primary btn-sm mt-3" id="addCaregiverButton">
                        ...
                        <?php
                        $questionnaireSteps = [
                            3 => ['title' => 'Adesione Attuale', 'questions' => [
                                'aderenza' => 'Quanto spesso il paziente segue la terapia prescritta?',
                                'difficolta' => 'Quali difficoltà incontra nel seguire la terapia?',
                                'supporto' => 'Riceve già supporto da familiari o caregiver?'
                            ]],
                            4 => ['title' => 'Stile di Vita', 'questions' => [
                                'alimentazione' => 'Com\'è l\'alimentazione abituale?',
                                'attivita' => 'Svolge attività fisica regolare?',
                                'riposo' => 'Qualità del sonno e riposo?'
                            ]],
                            5 => ['title' => 'Gestione Farmaci', 'questions' => [
                                'conservazione' => 'Come vengono conservati i farmaci?',
                                'organizzazione' => 'Utilizza strumenti per organizzare l\'assunzione (es. pilloliere)?',
                                'reazioni' => 'Sono state segnalate reazioni avverse?'
                            ]],
                            6 => ['title' => 'Monitoraggio', 'questions' => [
                            ...
                            7 => ['title' => 'Obiettivi e Motivazioni', 'questions' => [
                                'obiettivi' => 'Quali obiettivi terapeutici sono stati condivisi?',
                                'motivazione' => 'Livello di motivazione del paziente?',
                                'strategie' => 'Strategie concordate per migliorare l\'aderenza?'
                            ]],
                        ];
                        foreach ($questionnaireSteps as $stepNumber => $stepData): ?>
                            <section class="wizard-step" data-step="<?= $stepNumber ?>">
                                <h6 class="fw-semibold mb-3">
                                    <i class="fas fa-list-check me-2 text-primary"></i><?= htmlspecialchars($stepData['title']) ?>
                                </h6>
                                <?php foreach ($stepData['questions'] as $key => $label): ?>
                                    <div class="mb-3">
                                        <label class="form-label"><?= htmlspecialchars($label) ?></label>
                                        <textarea class="form-control questionnaire-input" data-question="<?= htmlspecialchars($key) ?>" rows="2"></textarea>
                                    </div>
                                <?php endforeach; ?>
                            </section>
                        <?php endforeach; ?>
                        ...
                        <section class="wizard-step" data-step="8">
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-select" name="signature_type" id="signatureType">
                                ...
                                <div class="col-12" id="signatureCanvasWrapper">
                                    <label class="form-label">Firma grafica del paziente / caregiver</label>
                                    <div class="signature-pad">
                                        <canvas id="consentSignaturePad"></canvas>
                                    </div>
                                    <div class="d-flex gap-2 mt-2">
                                        <button type="button" class="btn btn-outline-secondary btn-sm" id="clearSignatureButton">
                                            <i class="fas fa-eraser me-1"></i>Pulisci firma
                                        </button>
                                        <button type="button" class="btn btn-outline-primary btn-sm" id="saveSignatureButton">
                                            <i class="fas fa-save me-1"></i>Salva firma
                                        </button>
                                    </div>
                                    <small class="text-muted d-block mt-2">La firma verrà salvata con timestamp, indirizzo IP e associata alla terapia.</small>
                                </div>
                                <div class="col-lg-6 d-none" id="digitalSignatureWrapper">
                                    <label class="form-label">Firma digitale semplice</label>
                                    <input type="text" class="form-control" name="digital_signature" placeholder="Inserisci nome e cognome del firmatario">
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Note consenso informato</label>
                                    <textarea class="form-control" name="consent_notes" rows="3" placeholder="Note aggiuntive o condizioni specifiche"></textarea>
                                </div>
                            </div>
                        </section>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="therapy_reference" id="checkTherapySelect" required></select>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" name="actions" rows="2"></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="recurrence_rule" placeholder="Es. Ogni lunedì, ogni 12 ore, ecc.">
                        </div>
                        <div class="col-12">
            ...
            <form id="reportForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="reportTherapySelect" name="therapy_reference" required></select>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Destinatari del link</label>
                        <input type="text" class="form-control" name="recipients" placeholder="Email o note sul destinatario del link">
                    </div>
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="pin_code" placeholder="Inserisci un PIN per proteggere l\'accesso">
                        </div>
                    </div>
                    <div class="form-check mt-3">
                        <input class="form-check-input" type="checkbox" value="1" id="includeChecks" name="include_checks" checked>
                        <label class="form-check-label" for="includeChecks">
                            Includi storico check periodici nel report
                        </label>
                    </div>
                    <div class="alert alert-info mt-3">
                        Il report generato sarà disponibile tramite link pubblico condivisibile con medici e caregiver.
                    </div>
                    <div class="generated-report d-none" id="generatedReportContainer">
                        <h6 class="fw-semibold">Link pubblico generato</h6>
                        <div class="input-group">
                            <input type="text" class="form-control" id="generatedReportLink" readonly>
                            <button class="btn btn-outline-primary" type="button" id="copyReportLink">
